...
import { Building2, ClipboardList, KeyRound, LayoutDashboard, Menu, Settings, UserRound, Users, Wrench, X } from 'lucide-react';
import { LogoutButton } from '@/components/logout-button';
import { ThemeToggle } from '@/components/theme-toggle';

const links = [
  ['/dashboard', 'لوحة التحكم', LayoutDashboard],
  ['/dashboard/sales', 'عروض البيع', Building2],
  ['/dashboard/rentals', 'عروض الإيجار', KeyRound],
